...
async function fetchData() {
  try {
    ...
    console.log(data["1_1"].categoria);
  } catch (error) {
...
packing = {
  ...
  p6: {
    ...
    imagenes: [
      "../img/regalos-corporativos/paquete6/p6_1.png",
      "../img/regalos-corporativos/paquete6/p6_2.png",
      "../img/regalos-corporativos/paquete6/p6_3.png",
      "../img/regalos-corporativos/paquete6/p6_4.png",
      "../img/regalos-corporativos/paquete6/p6_5.png",
    ],
  },
  p7: {
    id: 7,
    ...
    imagenes: [
      "../img/regalos-corporativos/paquete7/p7_1.png",
      "../img/regalos-corporativos/paquete7/p7_2.png",
      "../img/regalos-corporativos/paquete7/p7_3.png",
      "../img/regalos-corporativos/paquete7/p7_4.png",
      "../img/regalos-corporativos/paquete7/p7_5.png",
    ],
  },
  p8: {
    id: 8,
...
function cargarGrid(productoIndex, packing) {
  ...
  ruteItem.innerHTML =
    "<h3>Catalogo > Regalos Corporativos > " +
...
function random_img(randomImg, db) {
  ...
  for (var i = 1; i <= 3; i++) {
    ...
    randItem.innerHTML =
      '<div class="pack"><a href="../regalos-corporativos/paquetesRC.html" onclick="captureParentName(' +
      packsChosenWQM[i] +
      ')"><img src="' +
      imagenUrl +
